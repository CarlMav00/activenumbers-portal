  ...
  const Sidebar = () => (
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {nav.map(n => <NavItem key={n.to} {...n} active={location.pathname === n.to || (n.to !== '/dashboard' && location.pathname.startsWith(n.to))} />)}
      </nav>
      <div className="px-3 py-4 border-t border-gray-100">
        ...
        <button onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-500 hover:bg-slate-100 hover:text-navy transition-all">
